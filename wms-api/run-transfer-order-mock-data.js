// Script to automatically insert Transfer Order mock data
...
async function runSqlScript() {
    console.log('==========================================');
    console.log('Transfer Order Mock Data Insertion');
    console.log('==========================================\n');
    ...
    try {
        ...
        const sqlFilePath = path.join(__dirname, '..', 'INSERT_TRANSFER_ORDER_MOCK_DATA.sql');
            ...
            for (const query of selectStatements) {
                try {
                    ...
                    if (Array.isArray(rows) && rows.length > 0) {
                        ...
                        if (rows.length > 20) {
                            console.log(`... (showing first 20 of ${rows.length} rows)`);
                        }
                    } else {
        ...
        console.log('\nYou can now view Transfer Orders in the desktop app.');
        console.log('');
